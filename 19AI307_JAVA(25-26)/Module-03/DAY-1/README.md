...
```
6.returns → finalPrice = purchaseWeight * effectiveRate

7.Override display() in base class to show general customer details.

8.Create child class RegularCustomer:
```
Override getDiscountRate() to return 2%.

Override display() to show customer type as Regular.
```
9.Create child class PremiumCustomer:
```
Override getDiscountRate() to return 5%.
```
10.Add calculateCashback() → returns 1% of final price.

11.Override display() to show final price + cashback.

12.Call display() to show the complete bill with discounts.
...
## OUTPUT:
<img width="884" height="700" alt="image" src="https://github.com/user-attachments/assets/b1a5e4a9-e5df-4348-885e-fb60544aa166" />
