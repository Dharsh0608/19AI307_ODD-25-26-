...
3.	Define an interface GameController with methods :jump(),shoot(),pause()

4.Create class PlayBoxController implementing the interface and defining console-specific button actions.

5.Create class XCubeController implementing the interface with its own button mapping.

6.Create class RetroFunController implementing the interface using classic button controls.

7.Create one controller object at a time.

8.Call the three methods (jump, shoot, pause) to demonstrate polymorphism.
...
## OUTPUT:
<img width="821" height="293" alt="image" src="https://github.com/user-attachments/assets/d76563f7-6dbf-4839-9c6f-7273bf83a3c0" />
